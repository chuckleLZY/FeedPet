...
<template>
  <div class="login_container">
    ...
    <br /><el-divider direction="vertical"></el-divider> <br /><el-divider
      direction="vertical"
    ></el-divider
    ><br /><el-divider direction="vertical"></el-divider><br /><el-divider
      direction="vertical"
    ...
    <br /><el-divider direction="vertical"></el-divider><br /><el-divider
      direction="vertical"
    ></el-divider
    ><br /><el-divider direction="vertical"></el-divider><br />
    <el-divider direction="vertical"></el-divider><br />
    <span style="font-size: 12px">注册代表您同意我们的</span
